...
function ControlsState:render()
    ...
    love.graphics.print('METEORS/ENEMYS. IT WILL FIRE THE SELECTED', 70, 365)
    ...
    love.graphics.setFont(gFonts['tiny'])
    love.graphics.print('INCREASES +3 THE HEALTH OF EARTH/PLAYER UPTO 10 SEC.', 400, 130)
    ...
    love.graphics.setFont(gFonts['tiny'])
    love.graphics.print('SHIELDS THE EARTH LAYER/PLAYER FOR 10 SEC. METEOR/S WENT PAST BY', 400, 197)
    love.graphics.print('WILL NOT AFFECT THE EARTHS HEALTH/ENEMY LASER WILL NOT AFFECT PLAYER.', 400, 212)
